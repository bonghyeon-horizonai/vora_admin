...
export const agentPromptHistoriesRelations = relations(agentPromptHistories, ({one}) => ({
	agent: one(agents, {
...
export const userPaymentInfosRelations = relations(userPaymentInfos, ({one}) => ({
	user: one(users, {
...
export const userPurchasesRelations = relations(userPurchases, ({one, many}) => ({
	product: one(products, {
...
export const purchaseToolQuotasRelations = relations(purchaseToolQuotas, ({one, many}) => ({
...
export const purchaseToolUsageLogsRelations = relations(purchaseToolUsageLogs, ({one}) => ({
	conversation: one(conversations, {
...
export const ragUserRelationsRelations = relations(ragUserRelations, ({one}) => ({
