...
import type { ToolWithI18n, LanguageCode } from '@/features/admin/tools';
import { createToolSchema, type CreateToolSchema } from '@/features/admin/tools';
import { createToolAction, updateToolAction } from '@/features/admin/tools/actions';
...
export default function ToolForm({ tool, isNew }: ToolFormProps) {
    ...
    const {
        ...
        resolver: zodResolver(createToolSchema) as unknown as Resolver<CreateToolSchema>,
        defaultValues,
    });
                    ...
                    <Controller
                        ...
                        render={({ field }) => (
                            <FormControl fullWidth>
                                ...
                                <Select {...field} label={t('tools-form-category')} value={field.value || ''}>
                                    {CATEGORIES.map((cat) => (
                        ...
                        render={({ field }) => (
                            <FormControl fullWidth>
                                ...
                                <Select
                                    ...
                                    value={field.value || ''}
                                    onChange={(e) => field.onChange(String(e.target.value) === '' ? null : Number(e.target.value))}
                                >
