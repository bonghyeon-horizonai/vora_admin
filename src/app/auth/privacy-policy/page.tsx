            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-primary">
                  At Gogo, we take your privacy seriously. This Privacy Policy
                  outlines the types of personal information we collect, how we
                  use it, and the steps we take to safeguard it.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <ul className="list-inside list-disc [&>li]:ml-2 [&>li:first-of-type]:mt-1">
                  ...
                  <li>
                    Usage Data: Pages visited, time spent, clicks, and other
                    analytic information
                  </li>
                  <li>
                    Cookies and Tracking Technologies: Data from cookies,
                    beacons, tags, and similar technologies
                  </li>
                </ul>
                <br />
                ...
                <ul className="list-inside list-disc [&>li]:ml-2 [&>li:first-of-type]:mt-1">
                  <li>
                    Trusted third-party service providers assisting in
                    operations
                  </li>
                  <li>
                ...
                <Typography variant="body1">
                  We use cookies to personalize your experience and analyze
                  traffic. You can adjust your browser settings to refuse
                ...
                <Typography variant="body1">
                  ...
                  [Insert Age, e.g., 13 or 16]. We do not knowingly collect
                ...
                <Typography variant="body1">
                  ...
                  will be posted on this page, and where appropriate, you may be
                  notified by email or through the website.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  ...
                  handle your data, you can reach out to us at: info@gogo.dev
                </Typography>
              </Box>
            </Box>
          </Box>
