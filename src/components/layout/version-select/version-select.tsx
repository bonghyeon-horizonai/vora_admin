  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem onClick={handleClose}>Next v7.3.0</MenuItem>
        <MenuItem onClick={handleClose}>Next v7.2.0</MenuItem>
        <MenuItem onClick={handleClose}>Next v7.1.0</MenuItem>
        <MenuItem onClick={handleClose}>Next v7.0.0</MenuItem>
      </Menu>
    </>
  );
}
